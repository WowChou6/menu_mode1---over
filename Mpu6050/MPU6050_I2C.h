...
#define MPU6050_IIC_SCL_Pin                GPIO_Pin_3	         //PA3
#define MPU6050_IIC_SDA_Pin                GPIO_Pin_2	         //PA2

#define	MPU6050_IIC_SCL                    PAout(3)
#define	MPU6050_IIC_SDA                    PAout(2)  
#define	MPU6050_IIC_SDA_IN                 PAin(2)              //读数据端口
